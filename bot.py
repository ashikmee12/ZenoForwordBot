...
def run_flask():
    # Render dynamic port provide করে, যা os.environ দিয়ে ধরা হয়
    port = int(os.environ.get("PORT", 8080))
    app.run(host='0.0.0.0', port=port)

# Background Thread-এ Flask Server চালু করা
...
# একাধিক ID পড়ার জন্য কোড আপডেট করা হয়েছে
...
# একাধিক ইউজারের এক্সেস চেক করার নিয়ম
